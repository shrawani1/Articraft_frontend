...
//           <Link to={`/view_product/${productInformation._id}`} className="btn btn-primary mt-2" style={{ borderColor: 'black', color: 'white', backgroundColor: 'lightnavy' }}>View this product</Link>
...
//     height: '100%',
//     position: 'relative',
//     cursor: 'pointer', // Pointer cursor to indicate clickable card
//   }}
//   onClick={() => navigate(`/view_product/${productInformation._id}`)} // Navigate to product details page
// >
//   <span
//     style={{
