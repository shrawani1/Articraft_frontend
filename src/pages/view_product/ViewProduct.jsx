...
//               <p><strong>Categories:</strong> {product.productCategory}</p>
...
//               </div>
//               <p><strong>Story behind this product: </strong>{product.productStory}</p>
//             </div>
//           </div>
//         </div>
  ...
  return (
    <div className="background">
      ...
      <div className="container mt-5">
        ...
        <div className="row mt-4">
          <div className="col-md-12">
            <div className="card product-story-box">
              <h4>Story Behind This Product</h4>
              <p>{product.productStory || "No story available for this product."}</p>
            </div>
          </div>
        </div>
