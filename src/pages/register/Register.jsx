...
import React, { useState } from "react";
import RegisterModal from "../../components/RegisterModal"; // Adjust the import path if necessary

const Register = () => {
    const [isRegisterOpen, setIsRegisterOpen] = useState(true); // Always open the modal on this page

    const handleClose = () => {
        // Optionally redirect after closing
        setIsRegisterOpen(false);
        // window.location.href = "/"; // Uncomment if you want to redirect to the homepage
    };
